...
<div class="mb-3">
    ...
    <input value="{{@$diarista->cep}}" type="text" class="form-control" id="cep" name="cep" required maxlength="8">
</div>
<div class="mb-3">
...
<div class="d-flex">
    ...
    <a href="{{ route('diaristas.index')}}" class="btn btn-success m-1">Voltar</a>
</div>
