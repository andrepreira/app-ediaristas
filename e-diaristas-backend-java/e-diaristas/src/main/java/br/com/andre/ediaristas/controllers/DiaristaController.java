package br.com.andre.ediaristas.controllers;
...
import br.com.andre.ediaristas.repositories.DiaristaRepository;
...
public class DiaristaController {
    ...
    public ModelAndView listar() {
        var moduleAndView = new ModelAndView("admin/diaristas/listar");

        moduleAndView.addObject("diaristas", repository.findAll());
